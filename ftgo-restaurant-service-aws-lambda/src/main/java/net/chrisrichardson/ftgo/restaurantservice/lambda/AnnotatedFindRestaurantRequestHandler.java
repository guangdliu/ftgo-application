...
public class AnnotatedFindRestaurantRequestHandler extends AbstractAutowiringHttpRequestHandler {
  ...
  protected Class<?> getApplicationContextClass() {
	/// 1. The Srping Java configuration class to use for the application context
