...
import net.chrisrichardson.ftgo.orderservice.web.ResponseEntity;
...
public class AnnotatedOrderHandlers {

  ///OrderServiceProxy.orderDestinations has orderServiceUrl and orderHistoryUrl
  private OrderServiceProxy orderService;
  private KitchenService kitchenService;
  private DeliveryService deliveryService;
  private AccountingService accountingService;

  public AnnotatedOrderHandlers(OrderServiceProxy orderService,
  ...
  /***
  public Mono<OrderInfo> OrderServiceProxy::findOrderById(String orderId) {
  ...
  ***/
  public Mono<ServerResponse> getOrderDetails(ServerRequest serverRequest) {
    ...
    /***
    OrderServiceProxy::findOrderById first makes a REST call through WebClient.
    The REST call returns a ResponseEntity<GetOrderResponse>, but WebClient converts 
    it into a React Mono.    
    ***/
