...
public class AnnotatedOrderConfiguration {
  ...
  public RouteLocator orderProxyRouting(RouteLocatorBuilder builder, OrderDestinations orderDestinations) {
    ...
    /***
    RouteLocator main responsibility is to get a URL to make a remote call
    for POST 	"/orders"
        PUT 	"/orders"
        POST	"/orders/**"
        PUT	    "/orders/**"
        
        Use orderDestinations.getOrderServiceUrl()
        
        GET		"/orders"
        
        Use 
    	orderDestinations.getOrderHistoryServiceUrl()
    ***/
  }
