...
@SpringBootTest(classes = AnnotatedOrderHistoryEventHandlersTest.TestConfiguration.class,
        webEnvironment = SpringBootTest.WebEnvironment.NONE)
@AutoConfigureStubRunner(ids =
        {"net.chrisrichardson.ftgo:ftgo-order-service-contracts"}
        )
@DirtiesContext
public class AnnotatedOrderHistoryEventHandlersTest {
  ...
  public static class TestConfiguration {
    ...
    public OrderHistoryDao orderHistoryDao() {
      ///1. Create a mock OrderHistoryDao
  ...
  public void shouldHandleOrderCreatedEvent() throws InterruptedException {
    ...
    /// 2. trigger the orderCreatedEvent stub to emit an OrderCreatedEvent
